...
With `idealf(x)` respectively `idealfIQR` using the ideal fourths a tenth function for the IQR computation was especially written for the Wilcox book.
...
# Because of the special code format in the following example (see: next chunk)
# I have here to include the complete code of the funtions
